...
Use `gsd_run query`, from the preamble above, for artifact verification against must_haves in PLAN frontmatter:
...
Use `gsd_run query`, from the preamble above, for key link verification against must_haves in PLAN frontmatter:
