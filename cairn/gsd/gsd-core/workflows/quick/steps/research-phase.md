...
<files_to_read>
- Project state (what's already built) is NOT in this list and is NOT a file to read: ask the binary for it with `gsd_run query state.load`, resolved by your own preamble.
