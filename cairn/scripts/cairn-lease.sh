...
# contract.
# Usage: cairn-lease.sh {acquire N|release N|retire N|renew [N]|status N
#                        |status --all|release --mine}
#                       [--project-dir DIR] [--json]
#        release vacates and leaves the issue open for the next acquire;
#        retire vacates AND closes the issue — the end of a phase.
